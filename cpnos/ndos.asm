...
;
; TODO: needs Z180 TRAP handler since 0000 intercepted.
;
;  EQUATIONS OF DATA 
;
...
;  SNIOS ROUTINES
;
NTWKIN	equ	snios$pg+0
NTWKST	equ	snios$pg+3
CNFTBL	equ	snios$pg+6
SNDMSG	equ	snios$pg+9
RCVMSG	equ	snios$pg+12
NTWKER	equ	snios$pg+15
NTWKBT	equ	snios$pg+18
